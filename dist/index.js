...
const ChurchesAdminRouter_1 = __importDefault(require("./Routes/Admin/ChurchesAdminRouter"));
...
app_1.default.use(`/api/admin/churches`, ChurchesAdminRouter_1.default);
