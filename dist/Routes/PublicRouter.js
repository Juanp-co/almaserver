...
/* Birthdays */
router.get(`/birthdays`, public_controller_1.getBirthdays);
/* Churches */
router.get(`/churches`, public_controller_1.getChurches);
/* Courses */
// list and counters
...
router.get(`/members/counters`, middleware_1.validateUser, public_controller_1.getPublicMembersTotals);
...
/* Resources */
router.get(`/resources`, middleware_1.validateUser, public_controller_1.getPublicResources);
