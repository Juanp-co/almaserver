define({ "api": [
        ...
        "Query params": [
          {
            ...
            "optional": false,
            "field": "slug",
            "description": "<p>Indica que el valor de '_id' será un 'slug'.</p>"
          }
        ],
        "Path params": [
          {
            ...
            "optional": false,
            "field": "_id",
            "description": "<p>ID o slug del curso del curso.</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "church",
            "description": "<p>ID de la iglesia a la que pertenece (si no se envía un valor, se asigna la iglesia principal por defecto).</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "filename": "Docs/Admin/AdminDocuments.js",
      ...
      "fields": {
        ...
        "resources Object[]": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "member",
            "description": "<p>Datos del miembro que subió el documento.</p>"
          },
          {
            "group": "resources Object[]",
            "type": "Number",
  ...
  },
  {
    "type": "post",
    "url": "/api/user",
    "title": "(03) Eliminar cuenta del usuario.",
    "version": "0.0.56",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "password",
            "description": "<p>Contraseña actual de la cuenta.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "title": "(05) Obtener cursos de un miembro.",
    "version": "0.0.28",
  ...
  },
  {
    ...
    "title": "(06) Obtener reportes de la cuenta.",
    "version": "0.0.43",
    "name": "getReportsUser",
    "group": "User",
    "header": {
  ...
  {
    "type": "put",
    "url": "/api/admin/users/:_id/reset-password",
    "title": "(08) Cambiar rol de un miembro.",
    "version": "0.0.57",
    "name": "resetPasswordUsersAdmin",
    "group": "UsersAdmin",
    "header": {
      "fields": {
        "Header": [
